...
import { IBus } from 'src/app/interfaces/bus';
import { SeatBookingService } from '../../services/seat-booking.service';
import { FormControl, FormGroup, Validators, FormArray } from '@angular/forms';
import { Router } from '@angular/router';
@Component({
  selector: 'app-booking-select-seats',
  templateUrl: './booking-select-seats.component.html',
  styleUrls: ['./booking-select-seats.component.css'],
})
export class BookingSelectSeatsComponent implements OnInit {
  head: string = 'Please Select Your Seats';

  busId: any;
  busDetails: IBus | undefined;
  journey: any;
  ...
  ngOnInit(): void {
    ...
    if (typeof this.journey == 'undefined') this.router.navigate(['']);
    else {
