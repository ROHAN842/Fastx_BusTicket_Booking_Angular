...
@Component({
  selector: 'app-booking-passenger-info',
  templateUrl: './booking-passenger-info.component.html',
  styleUrls: ['./booking-passenger-info.component.css'],
})
export class BookingPassengerInfoComponent implements OnInit {
  ...
  onFormSubmit() {
    this.submitted = true;
    if (this.passengerInfo.invalid) return;
